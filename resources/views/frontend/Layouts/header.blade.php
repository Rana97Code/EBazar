      ...
      <div class="container">
        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu">
            ...
            <li class="has-submenu">
              <a href="{{ route('mainproduct.show') }}">Shop</a>
              <ul class="submenu">
                <li class="has-submenu">
                  <a href="#">Shop Layout</a>
                  <ul class="submenu">
                    <li>
                      <a href="shop-2col">2 Columns</a>
                    </li>
                    <li>
                      <a href="{{ route('mainproduct.show') }}">3 Columns</a>
                    </li>
                    <li>
                      <a href="{{ route('products.show') }}">4 Columns</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="shop-single">Single Product</a>
                </li>
                <li>
